"""
Django settings for testapps_6 project.
...
WSGI_APPLICATION = 'testapps_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapps_6 API",
    "DESCRIPTION": "API documentation for testapps_6 App",
    "VERSION": "v1",
}
